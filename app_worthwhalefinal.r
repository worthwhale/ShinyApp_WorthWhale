...
#separate year into it's own column for whale sightings
whales_year <- sightings %>%
  select(-X1) %>%
  separate(datetime, into = c("date", "time"), sep = " ") %>%
  separate(date, into = c("month", "day", "year"), sep = "/")

#make table of only total whales sighted and year
...
# combine vessel totals, whales, and vessel categories into one df
...
ui <- navbarPage("Navigation Bar",
                 ...
                 tabPanel("Summary", tags$img(src = "sw.png", align = "center", width="80%",height="600px") ,
                          h3("Introduction"),
                          p("This app allows users to explore sperm whale sightings (2005-2018) and vessel traffic (2012-2018) off the west coast of Dominica. Due to extreme weather events, data is missing for 2006 and 2013 for whale sightings, and 2016 and most of 2012 for vessels. Whale sighting points are documented as clusters, meaning the research team sighted a group of sperm whales on the surface with coordinated behavior and within close proximity of each other. A total of 521 individual sperm whales have been identified in the eastern Caribbean via photo-identification, primarily off of Guadeloupe and Dominica. Vessel traffic points are recorded based on individual vessel identification number (Maritime Mobile Service Identity - MMSI). For data processing reasons, each vessel that visits the area is only accounted for once a year in this app. This app should be used as a visualization tool and not for analytical purposes. While navigating the app, users can explore the abundance of vessels and whales and visualize areas where vessels may be a threat to sperm whales due to their speed.") ,
                 ...
                 tabPanel("Meet the Whales",
                          h3("Sperm Whale Cluster Sightings 2005-2018") ,
                          p("Sperm whales (Physeter macrocephaslus) are the largest toothed whales and are commonly found in depths of 1000m or deeper, making the west coast of Dominica suitable habitat due to prey abundance of giant squid. The resident community of sperm whales found in the eastern caribbean are behaviorally distinct from any other sperm whale community due to their unique vocalizations (clicks). Use the year inputs below to visualize sperm whale distrubution from 2005-2018.") ,
                          p("Dr. Gero has studied this community for over 15 years, to read about each social unit population trends please see publication : The Critical Decline of Eastern Caribbean Sperm Whale Population, Shane Gero and Hal Whitehead, 2016.") ,
                 ...
                 tabPanel("Whale and Vessel Abundance and Interactions",
                          h3("Sperm Whale Sightings 2005-2018 with Vessel Overlay from User's Preferred Speed Range"),
                          ...
                          p("The line graph plots number of vessels and whales sighted per year from 2012- 2018 off the west coast of Dominica. Number of  vessels is measured by each individual MMSI that came to Dominica each year, if any vessel returned, it is not included in the number of vessels. The whale abundance is measured in number of whales sighted within each cluster, giving a total of whales sighted each year. A whale can be seen multiple days a year in different clusters, therefore the total number of whales is not individual whales, just individual sightings."),
                          ...
                          tabPanel("Vessel and Whale Abundance Graph",
                                   h3("Vessel and Sperm Whale Abundance off West Coast of Dominica 2012-2018"),
